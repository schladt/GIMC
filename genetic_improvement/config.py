...
Generate {num_variants} different C/C++ implementations that statisfy the following objectives:
{bsi_objectives}

The following unit test must be satisfied to validate each implementation:
```python
{unit_test_code}
```

The following is an example of code that satisfies the objectives and unit test:
{code_example}
